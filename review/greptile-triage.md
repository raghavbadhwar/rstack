...
Example entries:
```
2026-03-13 | raghav/myapp | fp | app/services/auth_service.rb | race-condition
2026-03-13 | raghav/myapp | fix | app/models/user.rb | null-check
2026-03-13 | raghav/myapp | already-fixed | lib/payments.rb | error-handling
```
